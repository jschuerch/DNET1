<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BMI.aspx.cs" Inherits="P11_BMI_2.BMI" %>
                ...
                <div style="min-height: 439px">
                    <table style="">
                        ...
                        <tr>
                            <td></td>
                            <td>
                                <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" CssClass="error-message" 
                                    Display="Dynamic" ControlToValidate="geburtsdatum" ErrorMessage="Ungültiges Datum"
                                    ValidationExpression="^\d{1,2}\.\d{1,2}\.(\d{2}$|\d{4}$)"></asp:RegularExpressionValidator>
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style1">Geburtsdatum: </td>
                            <td>
                                <asp:TextBox ID="geburtsdatum" Runat="server" style="margin-top: 0px;" CssClass="auto-style2"/>
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style7"></td>
                            <td class="auto-style6">
                                <input id="Reset" type="reset" value="reset" class="auto-style5" />
